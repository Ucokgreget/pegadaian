/**
 * QRIS TLV parser — parses a raw QRIS string into structured objects.
 *
...
/** Tags that contain nested TLV sub-elements (tags 26-51 + tag 62) */
 ...
 *
 * @param {string} data - Raw QRIS/EMVCo TLV string
 * @returns {{ tag: string, name: string, length: number, value: string, children?: any[] }[]}
 */
 ...
 * @returns {{ version: string, method: 'static'|'dynamic', merchantName: string, merchantCity: string, currency: string, amount?: string, crc: string, raw: any[] }}
 */
